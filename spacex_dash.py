...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site',
        values='class',
        title='Total Launches (All Sites)')
        return piechart
    else:
        # return the outcomes piechart for a selected site
        piechart = px.pie(filtered_df,
        names='class',
        title='Total Launch (Specific Site)')
        return piechart
...
def update_graph(entered_site, payload_slider):
    if entered_site == 'ALL':
        ...
        x="Payload Mass (kg)",
        y="class",
        title="Correlation of Payload and Success (All Sites)",
        ...
        x="Payload Mass (kg)",
        y="class",
        title="Correlation of Payload and Success (Specific Site)",
        color="Booster Version Category")
        return scatterplot
